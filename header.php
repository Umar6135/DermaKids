...
" href="./unser-verein.php" id="navbarDropdown" role="button"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle unser-verein
<?php if (basename($_SERVER['PHP_SELF']) == "hilfsangebote-eb.php") {
    echo 'active';
} ?>
" href="./hilfsangebote-eb.php" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false" onclick="location.href=this.href">
                                Hilfsangebote EB
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li class="dropdown-submenu">
                                    <a class="dropdown-item dropdown-toggle" href="./hilfsangebote-eb.php?tab=eb">EB-Betroffene</a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=eb&subTab=nav-home">Übersicht</a></li>
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=eb&subTab=nav-case">Case- & Wundmanagement </a></li>
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=eb&subTab=nav-sozialberatung">Sozialberatung  </a></li>
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=eb&subTab=nav-familientherapie">Familientherapie  </a></li>
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=eb&subTab=nav-ernahrungsberatung">Ernährungsberatung </a></li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                    <a class="dropdown-item dropdown-toggle" href="./hilfsangebote-eb.php?tab=umfeld">Umfeld</a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=umfeld&subTab=nav-home2">Übersicht</a></li>
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=umfeld&subTab=nav-Pflegedienste">Ärzte & Pflegedienste </a></li>
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=umfeld&subTab=nav-krankenkassen">Behörden & Krankenkassen  </a></li>
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=umfeld&subTab=nav-Kita">Kita & Schule  </a></li>
                                        <li><a class="dropdown-item" href="./hilfsangebote-eb.php?tab=umfeld&subTab=nav-offentlichkeit">Öffentlichkeit</a></li>
                                    </ul>
                                </li>
                            </ul>
