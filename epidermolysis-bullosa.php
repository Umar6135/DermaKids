        ...
        <div class="container container-wd">
            <div class="row gx-3">
                <div class="col-md-7">
                    ...
                    <span class="subtext">Wenn die Haut so verletzlich ist wie der Flügel eines Schmetterlings
                    </span>
                    <p>Wenn die Haut so verletzlich ist wie der Flügel eines Schmetterlings
    ...
    <section class="Eb">
        <div class="container">
            <div class="Eb-heading">
                <h3>EB-Symptome & Formen</h3>
                <p>Epidermolysis bullosa beruht auf einem Gendefekt. Je nach Auftreten dieses Defekts werden drei verschiedene EB-Hauptgruppen unterschieden. <a href="">mehr lesen</a></p>

            </div>
            <div class="Eb-img">
                <img src="./assets/img/eb-img.png" alt="">
            </div>
            <div class="Eb-items">
                <div class="Eb-item">
                    <h5>EBS</h5>
                    <ul>
                        <li>weit verbreitete Form</li>
                        <li>Blasenbildung</li>
                    </ul>
                </div>
                <div class="Eb-item">
                    <h5>JEB</h5>
                    <ul>
                        <li>Bereits seit der Geburt</li>
                        <li>Verzogert Entwicklung</li>
                    </ul>
                </div>
                <div class="Eb-item">
                    <h5>DEB</h5>
                    <ul>
                        <li>Abweichender Verlauf</li>
                        <li>Tiefere Wunden</li>
                    </ul>
                </div>
            </div>
            <div class="text-center">
